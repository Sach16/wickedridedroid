...
public class CaldroidFragment extends DialogFragment{
    ...
    public TextView getLeftArrowButton() {
        ...
        if(leftArrowButton!= null)
            ...
            return (TextView)getActivity().findViewById(R.id.calendar_left_arrow);
    }
    ...
    public TextView getRightArrowButton() {
        if(rightArrowButton!= null)
           return rightArrowButton;
            ...
            return (TextView)getActivity().findViewById(R.id.calendar_right_arrow);
    }
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        if (caldroidListener != null) {
                            if (!enableClickOnDisabledDates) {
                                if (month != dateTime.getMonth() || (minDateTime != null && dateTime.lt(minDateTime)) || (maxDateTime != null && dateTime.gt(maxDateTime)) || (disableDates != null && disableDates.indexOf(dateTime) != -1)) {
                                    return;
                                }
                            }
    ...
    protected void refreshMonthTitleTextView() {
        ...
        if(month == 1)
            leftArrowButton.setText(months[11]);
        else
            leftArrowButton.setText(months[month-2]);

        if(month == 12)
            rightArrowButton.setText(months[0]);
        else
            rightArrowButton.setText(months[month]);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rightArrowButton = (TextView) view.findViewById(R.id.calendar_right_arrow);
        ...
        leftArrowButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(!((month-1) == calTemp.get(Calendar.MONTH) && year == calTemp.get(Calendar.YEAR)))
                {
                    prevMonth();
                    dateCallback.getDates(true);
                }
        ...
        rightArrowButton.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
               // Toast.makeText(getActivity(),dateCallback.getDates(),Toast.LENGTH_SHORT).show();
                 // Passing the boolean as true as method getting called from Fragment
                nextMonth();
                dateCallback.getDates(true);
            }
        });
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            dateCallback = (DateCallBack) activity;
